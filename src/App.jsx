...
export default function App() {
  ...
  const [temConteudoDireita, setTemConteudoDireita] = useState(false);
  ...
  const verificarConteudoDireita = () => {
    ...
    const restante =
      ...
      setTemConteudoDireita(restante > 2);
  };

  useEffect(() => {
    requestAnimationFrame(verificarConteudoDireita);

    window.addEventListener("resize", verificarConteudoDireita);

    return () => {
      window.removeEventListener("resize", verificarConteudoDireita);
    };
  }, [loading, usuario, userRole]);
      ...
      <header className="app-header">
        ...
        >
          ...
          <nav
            className="nav-menu"
            ref={navMenuRef}
            onScroll={verificarConteudoDireita}
          >
            <button 
